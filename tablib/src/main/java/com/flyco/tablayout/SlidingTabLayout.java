...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColorStart = ta.getColor(R.styleable.SlidingTabLayout_tl_indicator_start_color, -1);
        mIndicatorColorEnd = ta.getColor(R.styleable.SlidingTabLayout_tl_indicator_end_color, -1);
        ...
        mIndicatorCornerRadiusLeft = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius_left, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorCornerRadiusTop = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius_top, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorCornerRadiusRight = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius_right, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
        mIndicatorCornerRadiusBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? -1 : 0));
